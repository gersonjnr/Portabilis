			...
			<div class="tab-content">
				...
				<div class="tab-pane active" id="formulario">
					...
					<div class="form-actions">      
						...
						<?php echo $this->Html->link( __( 'Novo Cadastro', true ), array( 'controller'=>'cursos', 'action'=>'adicionar' ), array( 'class'=>'btn cancel' ) ); ?>
				...
				<script type="text/javascript">
					...
					jQuery(function($){
						...
						$("#CursoValorInscricao").maskMoney({symbol:"R$ ",decimal:",",thousands:"."})
